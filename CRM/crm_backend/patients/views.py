...
def finance_record_list(request):
    records = FinanceRecord.objects.all()  # Получаем все записи
    return render(request, 'patients/finance_record_list.html', {'records': records})
...
def finance_record_create(request):
    if request.method == 'POST':
        ...
        form = FinancialRecordForm()
    return render(request, 'patients/finance_record_form.html', {'form': form})
...
def finance_record_update(request, pk):
    ...
    return render(request, 'patients/finance_record_form.html', {'form': form, 'record': record})
...
def finance_record_delete(request, pk):
    ...
    if request.method == 'POST':
        record.delete()
        return redirect('finance_record_list')
    return render(request, 'patients/finance_record_confirm_delete.html', {'record': record})
...
def finance_record_report(request):
    ...
    return render(request, 'patients/finance_record_report.html', {'data': uri})